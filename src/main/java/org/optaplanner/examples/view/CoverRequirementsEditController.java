...
public class CoverRequirementsEditController implements Initializable {
...
private ObservableList<ShiftType> shifttypeList = FXCollections.observableArrayList();
	...
	public void setCoverRequirements(CoverRequirements cover) {
		this.cover = cover;
		getShiftTypeList();
	...
	private void handleOk() {
		if (isInputValid()) {
			...
			okClicked = true;
			rosterService.updateCoverRequirements(cover);
