...
public class PatternEditController implements Initializable {
	...
	public void setPatternContractLineEdit(PatternContractLine patterndata) {
	...
	private void handleOk() {
			...
			okClicked = true;
			rosterService.updatePatternContractLine(patterndata);
