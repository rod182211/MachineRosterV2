...
public class SolutionBusiness<Solution_> {
    ...
    public void saveSolution(File file) {
        ...
        getCalendarDataList();
        //clear the database so only latest data
        rosterService.removeCalendarData(calendarList);
        NurseRoster calendar = (NurseRoster) solution;
        DataLogic calendarinput = new DataLogic();
        calendarinput.createCalander(calendar);
