...
public class SolverAndPersistenceFrame<Solution_> extends JFrame {
   ...
   // private Action exportAction;
    ...
    private class DataImportAction extends AbstractAction {
		...
		private static final String NAME = "DataBase Import...";
    ...
    private class ExportAction extends AbstractAction {
		...
		private static final String NAME = "Export as XML";
    ...
    private class ExcelExportAction extends AbstractAction {
		...
		private static final String NAME = "Export as Excel...";
        private final JFileChooser fileChooser;
