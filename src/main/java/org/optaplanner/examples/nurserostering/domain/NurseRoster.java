...
public class NurseRoster extends AbstractPersistable {
   ...
   // private List<ShiftTypeSkillRequirement> shiftTypeSkillRequirementList;
    ...
    @ProblemFactCollectionProperty
    private List<RosterDay> rosterOffRequestList;
    @ProblemFactCollectionProperty
 ...
 /*
    ...
    public List<RosterDay> getRosterOffRequestList() {
		return rosterOffRequestList;
	}

	public void setRosterOffRequestList(List<RosterDay> rosterOffRequestList) {
		this.rosterOffRequestList = rosterOffRequestList;
	}
    ...
    public List<TrainingRequest> getTrainingRequestList() {
